<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="MonetizationStrategies.aspx.cs" Inherits="MonetizationStrategies" %>
                        ...
                        <div class="span16 padding20 margin20">
                            <div class="tile-content">
                                <div class="panel no-border">
                                    <div class="panel-header bg-blue fg-white text-center">Monetization Strategies</div>
...
<script type="text/JavaScript">
    $(function () {
        $.ajax({
            type: "post",
            url: "MonetizationStrategies.aspx/GetMonetizationStrategieslist",
        ...
        <div class="row">
            ...
            <div class="accordion with-marker span12  place-right" data-role="accordion" data-closeany="false">
                ...
                <div class="accordion-frame active ">
                    ...
                    <div class="fb-save"
                        data-uri="http://gopala-krishna.com/UIProductManagement/MonetizationStrategies.aspx"
                        data-size="large">
                    </div>
                    <div class="fb-like"
                        data-href="http://gopala-krishna.com/UIProductManagement/MonetizationStrategies.aspx"
