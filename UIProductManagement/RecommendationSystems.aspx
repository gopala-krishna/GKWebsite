<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="RecommendationSystems.aspx.cs" Inherits="RecommendationSystems" %>
                        ...
                        <div class="span16 padding20 margin20">
                            <div class="tile-content">
                                <div class="panel no-border">
                                    <div class="panel-header bg-blue fg-white text-center">Recommendation Systems</div>
...
<script type="text/JavaScript">
    $(function () {
        $.ajax({
            type: "post",
            url: "RecommendationSystems.aspx/GetRecommendationSystemslist",
        ...
        <div class="row">
            ...
            <div class="accordion with-marker span12  place-right" data-role="accordion" data-closeany="false">
                ...
                <div class="accordion-frame active ">
                    ...
                    <div class="fb-save"
                        data-uri="http://gopala-krishna.com/UIProductManagement/RecommendationSystems.aspx"
                        data-size="large">
                    </div>
                    <div class="fb-like"
                        data-href="http://gopala-krishna.com/UIProductManagement/RecommendationSystems.aspx"
