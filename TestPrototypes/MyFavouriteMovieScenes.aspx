<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="MyFavouriteMovieScenes.aspx.cs" Inherits="MyFavouriteMovieScenes" %>
                        ...
                        <div class="span16 padding20 margin20">
                            <div class="tile-content">
                                <div class="panel no-border">
                                    <div class="panel-header bg-blue fg-white text-center">My Favourite Movie Scenes</div>
...
<div class="product">
<img src='#:MovieImageUrl#' onclick ="javascript:location.href='#=MovieUrl#'"/>
<%--    <h3>#:BookTitle#</h3>--%>
</div>
...
<script type="text/JavaScript">
    $(function () {
        $.ajax({
            type: "post",
            url: "MyFavouriteMovieScenes.aspx/GetMovielist",
