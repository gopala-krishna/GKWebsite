...
public partial class WebTechStackSearch : System.Web.UI.Page
{
    ...
    static string similarTechUrl; static string similarTechSiteUrl;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        similarTechSiteUrl = searchTerm.ToString();
        similarTechUrl = "https://www.similartech.com/websites/" + similarTechSiteUrl;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //#region NetCraft
        //string netCraftSource = GetHTMLSource(similarTechUrl);
        ...
        #region SimilarTech
        string similarTechSource = GetHTMLSource(similarTechUrl);

        if (similarTechSource != "")
        {
            //W3 Tech Source Parsing
            string similarTechStartWord = "Similar Sites";
            int similarTechStartIndex = similarTechSource.IndexOf(similarTechStartWord);
            int similarTechLength = similarTechSource.IndexOf("Benefits") - similarTechSource.IndexOf(similarTechStartWord);
            if (similarTechLength <= 0)
            {
                litSimilarTech.Text = "Can't be able to pull 1's and 0's";
            }
            else
            {
                string infoString = similarTechSource.Substring(similarTechSource.IndexOf(similarTechStartWord), similarTechLength);
                string formattedStr = infoString.Remove(0, 41);
                litSimilarTech.Text = formattedStr;
            }
        }
        else
        { litSimilarTech.Text = "Can't be able to pull 1's and 0's"; }

        #endregion SimilarTech
